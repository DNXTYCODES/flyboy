...
// const Hero = () => {
//   const slides = [
//     { type: 'video', src: assets.vid1 },
//     { type: 'image', src: assets.a12 },
//     { type: 'image', src: assets.b6 },
//   ];
//   const [currentIndex, setCurrentIndex] = useState(0);
...
//       {/* Hero Right Side - Slideshow */}
//       <div className="w-full sm:w-1/2 rounded-3xl relative overflow-hidden">
//         {slides.map((slide, index) => (
//           <div
//             key={index}
//             className={`absolute w-full h-full transition-opacity duration-1000 ${
...
// const Hero = () => {
//   const images = [assets.vid1, assets.a12, assets.b6]; // Replace with your image paths
//   const [currentIndex, setCurrentIndex] = useState(0);
