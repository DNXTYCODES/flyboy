...
//           <button onClick={()=>addToCart(productData._id)} className='bg-[#333333]  transition-all duration-500  text-white hover:bg-black hover:text-white px-8 py-3 text-sm active:bg-gray-700'>ADD TO CART</button>
//           <hr className='mt-8 sm:w-4/5' />
//           <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
//               <p>100% Original product.</p>
//               <p>Cash on delivery is available on this product.</p>
